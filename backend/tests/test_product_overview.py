...
def test_same_origin_frontends_are_served() -> None:
    ...
    assert "vinyrd-crest.webp" in staff.text
    ...
    assert favicon.headers["location"] == "/staff/assets/vinyrd-crest.webp"
...
def test_master_brand_assets_are_served() -> None:
    ...
    for path in (
        ...
        "/staff/assets/vinyrd-crest.webp",
        "/member/assets/vinyrd-full-logo.webp",
        "/member/assets/vinyrd-crest.webp",
    ):
